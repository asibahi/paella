...
And that's it. I do not even have to run the intermediate codepaths as no changes to instructions or assembly generation this chapter. There is a small extra credit of implementing `goto`, but I am skiiping extra credit this time.

---

## Lessons Learned

Not to repeating ranting at Zig's documentation, but I definitely now understand Zig's build system at a deeper level than before.
